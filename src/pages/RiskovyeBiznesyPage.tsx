...
export default function RiskovyeBiznesyPage() {
  ...
  const serviceFaqItems = [
    {
      question: 'Сколько стоит аудит рискового бизнеса?',
      answer: 'Цена от 30 000 ₽. Зависит от масштаба (количество товаров, каналов) и глубины проверки. Сделаем расчёт за 15 минут.'
    },
    {
      question: 'Сроки выполнения?',
      answer: 'Обычно 3–14 дней в зависимости от пакета. Точный график — после брифа и оценки объёма.'
    },
    {
      question: 'Какие гарантии?',
      answer: 'Юридическое заключение с выявленными рисками и планом действий. Есть договор и SLA по срокам.'
    }
  ];
