...
export default function TovarnyyZnakPage() {
  ...
  const serviceFaqItems = [
    {
      question: 'Сколько стоит регистрация товарного знака?',
      answer: 'От 60 000 ₽ за 3 класса МКТУ, дополнительные классы — по 5 000 ₽. Зависит от сложности обозначения, количества классов и необходимости ответов на запросы Роспатента. Сделаем расчёт за 15 минут.'
    },
    {
      question: 'Сроки выполнения?',
      answer: 'Обычно 10–14 месяцев для полной регистрации в Роспатенте. Точный график — после брифа и предварительной проверки на схожесть.'
    },
    {
      question: 'Какие гарантии?',
      answer: 'Гарантируем юридически корректную подачу заявки, ответы на все запросы Роспатента, защиту ваших интересов в спорных ситуациях. Есть договор и SLA.'
    }
  ];
